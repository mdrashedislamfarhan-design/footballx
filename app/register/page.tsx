...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Tv2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col items-center justify-center pt-24 pb-12 px-4 bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#666] text-sm mt-1">Start watching for free</p>
        </div>
        ...
        <div className="bg-[#111118] border border-white/[0.08] rounded-[28px] p-8 shadow-[0_32px_80px_rgba(0,0,0,0.6)]">
          ...
          {error && (
            <div className="mb-4 p-3 bg-[#FF5252]/10 border border-[#FF5252]/30 rounded-2xl text-xs text-[#FF5252] font-semibold">{error}</div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input type={showPw ? 'text' : 'password'} required placeholder="Password (min 6 chars)" value={password} onChange={e => setPassword(e.target.value)}
              ...
              <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#555] hover:text-white transition-colors">
          ...
          <p className="text-center text-xs text-[#555] mt-6">
            ...
            <Link href="/login" className="text-[#8B5CF6] hover:text-[#A78BFA] font-bold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
